...
interface PiUserGearDuotoneProps {
  className?: string;
}

export default function PiUserGearDuotone({
  className,
}: PiUserGearDuotoneProps) {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
