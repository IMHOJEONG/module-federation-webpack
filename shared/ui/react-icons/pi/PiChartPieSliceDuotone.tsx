...
interface PiChartPieSliceDuotoneProps {
  className?: string;
}

export default function PiChartPieSliceDuotone({
  className,
}: PiChartPieSliceDuotoneProps) {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
      ...
      className={className}
    >
      <path d="M96,37.5v72l-62.4,36A96,96,0,0,1,96,37.5Z" opacity="0.2"></path>
