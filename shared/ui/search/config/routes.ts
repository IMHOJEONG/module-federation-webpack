/**
 * @deprecated routes for template pages, use ktRoutes instead.
 */
export const routes = {
  eCommerce: {
    dashboard: "/ecommerce",
  ...
  signInChannelAuth: "/channel_auth",
  signInPlatformAuth: "/platform_auth",

  api_playground: "/api-playground",
  search_prototype: "/search-prototype",
};

export const ktRoutes = {
  signIn: {
    channelAuth: "/channel_auth",
    platformAuth: "/platform_auth",
  },
