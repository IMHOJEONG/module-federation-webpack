    ...
    >
      <defs>
        <linearGradient x1="8.042%" y1="0%" x2="65.682%" y2="23.865%" id="a">
          <stop stopColor={baseColor} stopOpacity="0" offset="0%" />
          <stop stopColor={baseColor} stopOpacity=".631" offset="63.146%" />
          <stop stopColor={baseColor} offset="100%" />
        </linearGradient>
      </defs>
      <g fill="none" fillRule="evenodd">
        <g transform="translate(1 1)">
          ...
          <circle fill={baseColor} cx="36" cy="18" r="1">
            <animateTransform
              attributeName="transform"
              type="rotate"
              from="0 18 18"
