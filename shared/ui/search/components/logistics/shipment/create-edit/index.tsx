import FormPaymentMethodInfo from "@/components/logistics/shipment/create-edit/form-payment-method-info";
import {
  shipmentFormSchema,
  CreateShipmentInput,
} from "@/validators/create-shipping.schema";
import FormRecipientInfo from "@/components/logistics/shipment/create-edit/form-recipient-info";
import FormShippingInfo from "@/components/logistics/shipment/create-edit/form-shipping-info";
import FormNav, {
  FormParts,
} from "@/components/logistics/shipment/create-edit/form-nav";
import FormPackageInfo from "@/components/logistics/shipment/create-edit/form-package-info";
import FormSenderInfo from "@/components/logistics/shipment/create-edit/form-sender-info";
import { defaultValues } from "@/components/logistics/shipment/create-edit/form-utils";
