...
import CartProduct from "@/components/ecommerce/cart/cart-product";
  ...
  return (
    <div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-4 @md:gap-6">
        ...
        <a href={routes.eCommerce.checkout}>
          <Button
            size="xl"
            rounded="pill"
            onClick={() => {
              // router.push(routes.eCommerce.checkout)
              navigate(routes.eCommerce.checkout);
            }}
            className="w-full"
          >
            Proceed To Checkout
