...
const StepOne = dynamic(
  () =>
    import(
      "@/components/appointment/appointment-list/appointment-form/data-time"
    ),
  {
    ssr: false,
  }
...
const StepTwo = dynamic(
  () =>
    import(
      "@/components/appointment/appointment-list/appointment-form/services"
    ),
  {
    ssr: false,
  }
...
const StepThree = dynamic(
  () =>
    import(
      "@/components/appointment/appointment-list/appointment-form/patient-information"
    ),
  {
    ssr: false,
  }
